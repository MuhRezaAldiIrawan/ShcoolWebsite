...
<head>
    ...
    <!-- Core css -->
    <link href="{{ asset('LoginAsset/css/app.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <div class="app">
        <div class="container-fluid p-h-0 p-v-20 bg full-height d-flex"
            style="background-image: url({{ url('LoginAsset/images/others/login-3.png') }})">
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-center m-b-30 ">
                                        <img class="img-fluid" alt="" src="{{ asset('images/logo.png') }}">
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center m-b-30 ">
    ...
    <!-- Core Vendors JS -->
    <script src="{{ asset('LoginAsset/js/vendors.min.js') }}"></script>

    <!-- page js -->

    <!-- Core JS -->
    <script src="{{ asset('LoginAsset/js/app.min.js') }}"></script>
